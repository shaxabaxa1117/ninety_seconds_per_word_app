...
class FormWidget extends StatefulWidget {
  const FormWidget(
      ...
      required this.func,
      this.hasChoosing = false, 
      this.forChanges = true});
  final String buttonName;
  final Function func;
  final bool hasChoosing;
...
class _FormWidgetState extends State<FormWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: ListView(
        children: [
          CardText(word: widget.buttonName, forChanges: widget.forChanges,),
          const SizedBox(
            height: 40,
          ),
          WordTextField(
              ...
              ? Container(
                  ...
                  child: TextButton(
                    ...
                    child: Text(
                      ...
                      style:
                          TextStyle(color: Color.fromARGB(181, 137, 49, 172)),
                    ),
                  ))
              : Row(
                  children: [
